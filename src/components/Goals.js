  ...
  <div>
    <div className="goals-container">
      ...
      <div className="goals-content">
        <p className="desc_en">
          our company is to revolutionize the world of luxury leasing by fostering an environment of
        ...
        <p className="desc_ar">
          تهدف شركتنا إلى إحداث ثورة في عالم التأجير الفاخر من خلال تعزيز بيئة من الإبداع والابتكار
